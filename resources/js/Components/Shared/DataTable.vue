...
const emit = defineEmits(['table:creating', 'table:updating', 'table:deleting']);
  ...
  <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
      ...
      <div
        ...
        <button @click="emit('table:creating')" type="button"
          class="flex items-center justify-center text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm pl-2 pr-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
    ...
    <div class="overflow-x-auto">
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr class="border-b dark:border-gray-700" v-for="item in data" :key="item.id">
            <td class="px-4 py-3" v-for="column in columns" :key="column.key">
              <slot :name="column.key" :item="item">
                {{ item[column.key] }}
              </slot>
            </td>
            <td v-if="hasActions" class="px-4 py-3 flex items-center justify-end">
